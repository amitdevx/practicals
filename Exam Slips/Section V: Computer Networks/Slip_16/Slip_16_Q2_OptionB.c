...
void displayFrameDetails(const char *frame) {
    ...
    printf("\n┌────────────────────────────────────────────────────────────────┐\n");
    printf("│                    FRAME STRUCTURE BREAKDOWN                   │\n");
    printf("├────────────────────────────────────────────────────────────────┤\n");
    ...
    printf("│ Start Delimiter: [DLE][STX] = '%c%c'                            │\n", DLE, STX);
    printf("│ End Delimiter:   [DLE][ETX] = '%c%c'                            │\n", DLE, ETX);
    printf("└────────────────────────────────────────────────────────────────┘\n");
}
...
void displayMenu() {
    ...
    printf("├───────────────────────────────────────────────┤\n");
    printf("│ 1. Character Stuffing (Sender)                │\n");
    printf("│ 2. Character Destuffing (Receiver)            │\n");
    printf("│ 3. Bit Stuffing (Sender)                      │\n");
    printf("│ 4. Bit Destuffing (Receiver)                  │\n");
    printf("│ 5. Demo - Character Stuffing                  │\n");
    printf("│ 6. Demo - Bit Stuffing                        │\n");
    printf("│ 7. Exit                                       │\n");
    printf("└───────────────────────────────────────────────┘\n");
...
int main() {
    ...
    printf("║              Slip 16 - Option B                               ║\n");
    printf("║                                                               ║\n");
    printf("║   Character Stuffing: Using '%c' as DLE, '%c' as STX, '%c' as ETX ║\n", 
           DLE, STX, ETX);
    printf("║   Bit Stuffing: Using 01111110 as flag                        ║\n");
    printf("╚═══════════════════════════════════════════════════════════════╝\n");
    ...
    while (1) {
        ...
        switch (choice) {
            case 1:
                ...
                printf("\n┌────────────────────────────────────────────────┐\n");
                printf("│ STUFFING RESULT                                │\n");
                printf("├────────────────────────────────────────────────┤\n");
                printf("│ Original Data: %s\n", data);
                printf("│ Original Length: %lu bytes\n", strlen(data));
                printf("│ Stuffed Frame: %s\n", frame);
                printf("│ Frame Length: %lu bytes\n", strlen(frame));
                printf("│ Overhead: %lu bytes\n", strlen(frame) - strlen(data));
                printf("└────────────────────────────────────────────────┘\n");
            ...
            case 3:
                ...
                printf("\n┌────────────────────────────────────────────────┐\n");
                printf("│ BIT STUFFING RESULT                            │\n");
                printf("├────────────────────────────────────────────────┤\n");
                printf("│ Original:  %s\n", data);
                printf("│ Stuffed:   %s\n", frame);
                printf("│ Original bits: %lu\n", strlen(data));
                printf("│ Frame bits: %lu\n", strlen(frame));
                printf("└────────────────────────────────────────────────┘\n");
                break;
            ...
            case 5:
                printf("\n╔═══════════════════════════════════════════════════════════════╗\n");
                printf("║               DEMO - CHARACTER STUFFING                       ║\n");
                printf("╚═══════════════════════════════════════════════════════════════╝\n");
 ...
 * ║              Slip 16 - Option B                               ║
 * ║                                                               ║
 * ║   Character Stuffing: Using '#' as DLE, '{' as STX, '}' as ETX║
 * ║   Bit Stuffing: Using 01111110 as flag                        ║
 * ╚═══════════════════════════════════════════════════════════════╝
 * 
 * --- DEMO - CHARACTER STUFFING ---
 * 
 * [Demo 1: Simple message without DLE character]
 *   Original Data:   'HELLO WORLD'
 *   Stuffed Frame:   '#{HELLO WORLD#}'
 *   Extracted Data:  'HELLO WORLD'
 *   Verification:    ✓ PASS
 * 
 * [Demo 2: Message containing DLE character '#']
 *   Original Data:   'DATA#LINK#ESCAPE'
 *   Stuffed Frame:   '#{DATA##LINK##ESCAPE#}'
 *   Extracted Data:  'DATA#LINK#ESCAPE'
 *   Note: Each '#' in data becomes '##' in frame
 *   Verification:    ✓ PASS
 * 
 * --- DEMO - BIT STUFFING ---
 * 
 * [Demo 3: Data containing flag pattern 01111110]
 *   Original:    01111110 (looks like flag!)
 *   Frame:       01111110011111010001111110
 *   Extracted:   01111110
 *   Note: 111111 becomes 1111101 (prevents false flag)
 *   Verification: ✓ PASS
 */
